...
#include "comm.h"
//#include "stabilizer.h"  // Disabled for servo controller mode
...
#include "sound.h"
#include "sysload.h"
//#include "estimator_kalman.h"  // Disabled for servo controller mode
//#include "deck.h"
//#include "extrx.h"
#include "app.h"
...
void systemTask(void *arg)
{
  ...
  // SERVO CONTROLLER MODE - No stabilizer, no sensors, no estimator
  // StateEstimatorType estimator = anyEstimator;
  // estimatorKalmanTaskInit();
  // stabilizerInit(estimator);
  
  // Initialize servo controller instead
  servoControllerInit();
  ...
  // SERVO CONTROLLER MODE - Replace stabilizer/estimator tests
  // pass &= stabilizerTest();
  // DEBUG_PRINTI("stabilizerTest = %d ", pass);
  // pass &= estimatorKalmanTaskTest();
  // DEBUG_PRINTI("estimatorKalmanTaskTest = %d ", pass);
  pass &= servoControllerTest();
  DEBUG_PRINTI("servoControllerTest = %d ", pass);
  //pass &= deckTest();
  //pass &= soundTest();
  //pass &= memTest();
