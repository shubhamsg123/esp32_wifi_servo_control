...
/******** MG995 Servo Defines ********/
#define SERVO_FREQ_HZ     50      // 50Hz for servo PWM
#define SERVO_MIN_US      1000    // 1ms - Full CCW
#define SERVO_MID_US      1500    // 1.5ms - Stop/Neutral
#define SERVO_MAX_US      2000    // 2ms - Full CW
 ...
 */
void servoWriteMicroseconds(uint32_t id, uint16_t microseconds);
